...
void CSAudioFileStreamPropertyListener(void *inClientData, AudioFileStreamID inAudioFileStreamID, AudioFileStreamPropertyID inPropertyID, UInt32 *ioFlags)
{
    CSAudioFileStream *audioFileStream = (__bridge CSAudioFileStream *)inClientData;
    [audioFileStream didChangeProperty:inPropertyID flags:ioFlags];
}

void CSAudioFileStreamPacketsListener(void *inClientData, UInt32 inNumberBytes, UInt32 inNumberPackets, const void *inInputData, AudioStreamPacketDescription *inPacketDescriptions)
{
    CSAudioFileStream *audioFileStream = (__bridge CSAudioFileStream *)inClientData;
...
@implementation CSAudioFileStream
...
- (instancetype)init
{
    ...
    OSStatus err = AudioFileStreamOpen((__bridge void *)self, CSAudioFileStreamPropertyListener, CSAudioFileStreamPacketsListener, 0, &_audioFileStreamID);
